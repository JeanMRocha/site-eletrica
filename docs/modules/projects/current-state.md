...
- O projetador existe como base funcional e ainda está em evolução.
- O canvas 2D inicial permite inserir, selecionar, arrastar e redimensionar ambientes com alças auxiliares.
